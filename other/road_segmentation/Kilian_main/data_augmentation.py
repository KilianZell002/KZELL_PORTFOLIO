...
images_path=        "/content/data/images"             #Path to the folder with the satelite images
masks_path=         "/content/data/groundtruth"        #Path to the folder with the groundtruth images
images_aug_path =   "/content/data/aug_data/images"    #Path to the augmented sat images
masks_aug_path =    "/content/data/aug_data/masks"     #Path to the augmented groundtruth images (called masks)
...
if __name__ == "__main__": 
    ...
    input_folder = "/content/data/aug_data"
    output =       "/content/data/processing"
